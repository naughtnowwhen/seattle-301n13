...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT because the scope was changed, var i believe has function scope while let has block, so rando became out of scope and therefore wasnt accesible
  console.log(viewed);
